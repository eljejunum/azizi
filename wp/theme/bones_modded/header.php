...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<!--LESS client side functionality-->
		<link rel="stylesheet/less" type="text/css" href="<?php echo get_template_directory_uri(); ?>/library/less/style.less" />
		<script src="<?php echo get_template_directory_uri(); ?>/library/less/less-min.js" type="text/javascript"></script>
		...
		<div id="container">
			...
			<header class="header" role="banner">
				...
				<div id="inner-header" class="wrap clearfix">
					...
					<div id="top-tabs">
						...
						<a id="email-tab" href="mailto:"><img src="<?php echo get_template_directory_uri(); ?>/images/azizi_email.png"></a>
			...
			<div id="header-banner" role="banner"> 
				...
				<div id="inner-header-banner" class="wrap">
					...
					<div class="fivecol clearfix" id="header-banner-text">
						<img src="<?php echo get_template_directory_uri();?>/images/azizi_header-alt_text.png">
					</div>
			...
			<div id="home-banner" role="banner"> 
				...
				<div id="inner-home-banner" class="wrap clearfix row">
					...
					<div class="ninecol clearfix" id="home-special-content">
						<div>
							<img src="<?php echo get_template_directory_uri();?>/images/azizi_header_text_01.png">
						</div>
						<div id ="home-boxes">
							<div id="header-video">
						...
						<div id="header-consultation">
							<img src="<?php echo get_template_directory_uri();?>/images/azizi_header_text_02.png">
						</div>
